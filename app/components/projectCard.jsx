    ...
    return (
        <div>
            <div style={{ background: `url(${imgUrl})`, backgroundSize: "cover" }} className='h-52 md:h-72 rounded-t-xl relative group'>
                <div className='overlay items-center absolute justify-center top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500'>
            ...
            <div className='text-white rounded-b-xl bg-[#181818] py-6 px-4'>
                <h2 className='font-xl font-semibold mb-2'>{title}</h2>
